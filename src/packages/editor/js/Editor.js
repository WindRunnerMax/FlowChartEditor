 ...
 * Images below are for lightbox and embedding toolbars.
 */
Editor.maximizeImage = maximizeImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.zoomOutImage = zoomOutImage;
/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.zoomInImage = zoomInImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.zoomFitImage = zoomFitImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.layersImage = layersImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.previousImage = previousImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.nextImage = nextImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.editImage = editImage;
/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.zoomOutLargeImage = zoomOutLargeImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.zoomInLargeImage = zoomInLargeImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.actualSizeLargeImage = actualSizeLargeImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.printLargeImage = printLargeImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.layersLargeImage = layersLargeImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.closeLargeImage = closeLargeImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.editLargeImage = editLargeImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.previousLargeImage = previousLargeImage;

/**
 * Specifies the image URL to be used for the transparent background.
 */
Editor.nextLargeImage = nextLargeImage;

/**
 * Specifies the image to be used for the refresh button.
 */
Editor.refreshLargeImage = refreshLargeImage;

/**
 * Specifies the image to be used for the back button.
 */
Editor.backLargeImage = backLargeImage;

/**
 * Specifies the image to be used for the back button.
 */
Editor.fullscreenLargeImage = fullscreenLargeImage;
